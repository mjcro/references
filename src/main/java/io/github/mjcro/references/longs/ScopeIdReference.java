...
public interface ScopeIdReference {
     ...
     */
    static <T extends ScopeIdReference> List<T> filter(Collection<T> source, long scopeId) {
     ...
     */
    static Predicate<ScopeIdReference> predicate(final long expectedScopeId) {
